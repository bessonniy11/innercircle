# 📡 API Документация "Inner Circle"

## 📖 Обзор API

Этот документ содержит полную документацию по REST API и WebSocket событиям семейного мессенджера "Inner Circle". API построен на NestJS и использует JWT аутентификацию.
...
#### **GET /users** 🔒
Получение списка всех пользователей семьи.
...
**📡 Версия API:** 1.0.0  
**🎯 Статус:** Актуальная документация всех реализованных endpoints ✅
