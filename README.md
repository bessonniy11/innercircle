...
### 💡 **Основная Цель: Простота и Привычность**
- Приложение должно быть **максимально похожим на WhatsApp или Telegram** в плане пользовательского интерфейса и основных функций, чтобы обеспечить привычный и интуитивно понятный опыт для пользователей.
...
### **Основные Документы**
- **[UX/UI Дизайн и Пользовательские Сценарии](docs/user_experience_design.md):** 🎨 **НОВОЕ!** Детальное описание всех экранов, флоу и функционала
