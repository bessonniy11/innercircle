...
- [x] **Семейный чат:** Отображается в приложении и пользователи автоматически добавляются ✅

### 🔄 **В Процессе**
- [x] **Создание чатов:** Семейный чат создается и отображается ✅
- [ ] **Полная работа семейного чата:** Доработка real-time сообщений (отправка/получение)
